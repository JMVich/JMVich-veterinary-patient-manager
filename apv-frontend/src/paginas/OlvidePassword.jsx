...
const OlvidePassword = () => {
    ...
    const handleSubmit = async e => {
        ...
        if (email.length < 6) {
            setAlerta({ msg: 'El email es muy corto', error: true })
            return
        }
    ...
    return (
        <>
            <div>
                <h1 className="text-indigo-600 font-black text-5xl sm:text-6xl">Recupera tu acceso y no pierdas <span className="text-black">tus pacientes</span></h1>
            </div>
